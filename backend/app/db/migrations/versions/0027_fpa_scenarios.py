...
def upgrade() -> None:
    ...
    op.create_index(
        "ix_fpa_scenarios_organization_id", "fpa_scenarios", ["organization_id"]
    )
    op.create_index(
        "ix_fpa_scenarios_fiscal_year_id", "fpa_scenarios", ["fiscal_year_id"]
    )
    ...
    op.create_index(
        "ix_fpa_scenario_assumptions_organization_id",
        "fpa_scenario_assumptions",
        ["organization_id"],
    )
    op.create_index(
        "ix_fpa_scenario_assumptions_scenario_id",
        "fpa_scenario_assumptions",
        ["scenario_id"],
    )
    op.create_index(
        "ix_fpa_scenario_assumptions_fiscal_period_id",
        "fpa_scenario_assumptions",
        ["fiscal_period_id"],
    )
    op.create_index(
        "ix_fpa_scenario_assumptions_account_id",
        "fpa_scenario_assumptions",
        ["account_id"],
    )
    op.create_index(
        "ix_fpa_scenario_assumptions_dimension_value_id",
        "fpa_scenario_assumptions",
        ["dimension_value_id"],
    )
    op.create_index(
        ...
        "fpa_scenario_assumptions",
        ["organization_id", "scenario_id", "fiscal_period_id", "account_id"],
        unique=True,
...
def downgrade() -> None:
    op.drop_index(
        "uq_fpa_assumption_scope_without_dimension",
        table_name="fpa_scenario_assumptions",
    )
