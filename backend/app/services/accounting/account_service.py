...
class AccountService:
    ...
    async def create_account(self, organization_id: str, data: AccountCreate) -> Account:
        ...
        await self._related_account(organization_id, data.collective_account_id, "Collective account not found")
    ...
    async def update_account(self, organization_id: str, account_id: str, data: AccountUpdate) -> Account:
        ...
        if data.parent_id is not None:
            ...
            await self._related_account(organization_id, data.parent_id, "Parent account not found")
    ...
    async def _related_account(self, organization_id: str, account_id: str | None, message: str) -> Account | None:
