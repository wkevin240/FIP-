...
from app.api.v1.accounting.closing_signoff import router as closing_signoff_router
...
from app.api.v1.supplier_payment_allocations import (
    router as supplier_payment_allocations_router,
)
...
api_router.include_router(
    closing_signoff_router,
    prefix="/accounting/closing-signoff",
    tags=["Accounting - Closing Sign-off"],
)
api_router.include_router(
...
api_router.include_router(
    supplier_payment_allocations_router,
    prefix="/procurement",
    tags=["Procurement - AP Allocations"],
)
api_router.include_router(
