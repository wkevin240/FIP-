...
from app.api.v1.treasury.liquidity_control import router as liquidity_control_router
...
api_router.include_router(
    liquidity_control_router,
    prefix="/treasury/liquidity-control",
    tags=["Treasury - Liquidity Control"],
)
api_router.include_router(
