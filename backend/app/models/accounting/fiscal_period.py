from sqlalchemy import CheckConstraint, Column, Date, Enum as SQLEnum, ForeignKey, String, UniqueConstraint
...
class FiscalPeriod(Base):
    ...
    __table_args__ = (
        UniqueConstraint("organization_id", "fiscal_year_id", "name", name="uq_fiscal_period_organization_year_name"),
    ...
    status = Column(SQLEnum(FiscalPeriodStatus), default=FiscalPeriodStatus.OPEN, nullable=False)
